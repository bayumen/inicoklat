<template>
   <div class="hero">
       ...
       <div class="d-none d-md-block">
        ...
        <div class="col-md-6">
            <div class="d-flex h-100">
                <div class="justify-content-center align-self-center">
                    <h2><strong>Delicious Drink, </strong> <br> in Your Gedget </h2>
                    <p>Ayo segera pilih dan pesan minuman coklat favorit anda</p>
        ...
        <div class="col-md-6">
            <img src= "../assets/images/tampil.jpeg" width="50%"/>
        </div>
        </div>
       </div>
    ...
    <div class="d-sm-block d-md-none">
        <div class="row mt-4">
            ...
            <img src= "../assets/images/tampil.jpeg" width="100%"/>
        </div>
        <div class="col-md-6">
            <div class="d-flex h-100">
                <div class="justify-content-center align-self-center">
